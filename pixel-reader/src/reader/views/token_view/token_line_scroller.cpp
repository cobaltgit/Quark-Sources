...
void TokenLineScroller::clear_buffer()
{
    lines_buf.clear();
    current_line = 0;
    global_first_line = std::experimental::fundamentals_v1::nullopt;
    global_end_line = std::experimental::fundamentals_v1::nullopt;
}
...
std::experimental::optional<int> TokenLineScroller::first_line_number() const
{
    return global_first_line;
}

std::experimental::optional<int> TokenLineScroller::end_line_number() const
{
    return global_end_line;
}

SDL_Surface *TokenLineScroller::load_scaled_image(const std::experimental::filesystem::path &path)
{
    {
