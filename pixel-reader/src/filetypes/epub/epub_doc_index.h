...
struct Document
{
    std::experimental::filesystem::path zip_path;
    ...
    Document();
    Document(std::experimental::filesystem::path zip_path);
};
...
class EpubDocIndex
{
    ...
    mutable std::vector<std::experimental::optional<uint32_t>> doc_widths_cache;
